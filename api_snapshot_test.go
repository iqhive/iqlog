...
func TestExportedAPISnapshot(t *testing.T) {
	...
	canonical := []string{
		...
		"method Config", "method SetConfig", "method Level", "method Enabled", "method Dropped", "method LastWriteError", "method Flush", "method Close", "method WithContext", "method WithFields", "method WithError", "method Event", "method EventAt", "method SlogHandler", "method TraceEvent", "method DebugEvent", "method InfoEvent", "method WarnEvent", "method ErrorEvent", "method PanicEvent", "method FatalEvent",
	...
	legacy := []string{
		"const LevelPrint", "func NewIQLogger", "func NewGlobalIQLogger", "func Init", "func Warning", "func Warningf", "func Warningln", "func TraceWith", "func DebugWith", "func InfoWith", "func WarnWith", "func ErrorWith", "func PanicWith", "func FatalWith", "func SetWriter", "func GetWriter", "func SetLevel", "func SetDebugMode", "func SetCallerDepth", "func SetUseColour", "func SetUseColor", "func SetJSONTimeMode", "func SetNewLine", "func SetApplicationName", "func SetSyslogHost", "func Flush",
		"method Warning", "method Warningf", "method Warningln", "method TraceWith", "method DebugWith", "method InfoWith", "method WarnWith", "method ErrorWith", "method PanicWith", "method FatalWith", "method SetWriter", "method SetAsyncWriter", "method SetRingbufferWriter", "method SetRingBufferWriter", "method GetWriter", "method SetLevel", "method SetDebugMode", "method SetCallerDepth", "method SetUseColour", "method SetUseColor", "method SetJSONTimeMode", "method SetNewLine", "method SetApplicationName", "method SetSyslogHost", "method LogWithFields", "method LogFWithFields",
	}
