...
func TestExportedAPISnapshot(t *testing.T) {
	...
	canonical := []string{
		...
		"func New", "func MustNew", "func Default", "func SetDefault", "func Enabled", "func Dropped", "func ParseLevel", "func LastWriteError", "func InstallEventLogSource", "func RemoveEventLogSource",
