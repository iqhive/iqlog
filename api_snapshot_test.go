...
func TestExportedAPISnapshot(t *testing.T) {
	...
	sort.Strings(actual)
	canonical := []string{
		"type Config", "type Event", "type Format", "type Level", "type Logger", "type OverflowPolicy", "type WriterMode",
		"var ErrClosed", "var ErrWriteDropped", "const FormatConsole", "const FormatJSON", "const OverflowBlock", "const OverflowDrop", "const OverflowSync", "const WriterAsync", "const WriterRing", "const WriterSync",
		...
		"method Config", "method SetConfig", "method Level", "method Enabled", "method Dropped", "method LastWriteError", "method Flush", "method Close", "method WithContext", "method WithFields", "method WithError", "method Event", "method TraceEvent", "method DebugEvent", "method InfoEvent", "method WarnEvent", "method ErrorEvent", "method PanicEvent", "method FatalEvent",
